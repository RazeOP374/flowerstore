...
namespace MdFlower.Common
{
    public class DbContext
    {
        ...
        {
            ConnectionString = "Data Source=REZE-FOREVER-MI;Initial Catalog =dbc ;User ID=da;Password=123456",//连接符字串
        ...
        public static void InitDataBase()
        {
            ...
            string nspace = "Flower.Model.Entity";
            Type[] ass = Assembly.LoadFrom("C:/Users/49140/Desktop/demo/Myflower/Flower.Model/bin/Debug/net6.0/Flower.Model.dll").GetTypes().Where(p => p.Namespace == nspace).ToArray();
